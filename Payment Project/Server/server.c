...
{
	account_Data[num] = accountRefrence[num++];
...
void isValidAccountTest(void)
{
	...
	strcpy(tD.cardHolderData.primaryAccountNumber, "1234");
	strcpy(acc.primaryAccountNumber, "1234");

	isValidAccount(&tD.cardHolderData, &acc);
...
void isAmountAvailableTest(void)
{
	...
	tD.terminalData.transAmount = 1234;
	acc.balance = 12345;

	isAmountAvailable(&tD.terminalData, &acc);
	...
	tD.terminalData.transAmount = 12345;
	acc.balance = 1234;
...
void saveTransactionTest(void)
{
	...
	tD.terminalData.maxTransAmount = 5000.0;
	tD.terminalData.transAmount = 2000.0;
	tD.transactionSequenceNumber = 10;
